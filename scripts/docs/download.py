...
- scripts/docs/generate.py 会从 raw_html 提取 canonical 并生成/覆盖对应的 *.zh-CN.md。

运行（本仓库推荐）：
  uv run python "scripts/docs/download.py"

可选：
  uv run python "scripts/docs/download.py" --only "configuration,backtesting"
"""
