...
用法:
    uv run python scripts/analysis/param_sweep.py --help
"""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--configs",
        nargs="+",
        default=["configs/freqai/lgbm_trend_v1_eval.json"],
    ...
    parser.add_argument(
        "--strategy-param-file",
        default="strategies/freqai_lgbm_trend_strategy.json",
...
def main() -> int:
    ...
    sweep_root = repo_root / "backtest_results" / "sweeps" / run_id
