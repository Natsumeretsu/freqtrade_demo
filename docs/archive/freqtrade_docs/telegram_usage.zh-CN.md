# Telegram 使用（Telegram usage）

这份文档由 Freqtrade 官方页面离线保存后整理为便于“vibe coding 查阅使用”的 Markdown。

- 来源：https://www.freqtrade.io/en/stable/telegram-usage/
- 离线保存时间：Mon Jan 05 2026 11:38:10 GMT+0800 (中国标准时间)
...
For a description of the Bot API, see this page: [https://core.telegram.org/bots/api](https://core.telegram.org/bots/api) Father bot will return you the token (API key)
...
- `strategy_msg` - Receive notifications from the strategy, sent via `self.dp.send_msg()` from the strategy [more details](https://www.freqtrade.io/en/stable/strategy-customization/#send-notification).
...
[More details](https://www.freqtrade.io/en/stable/configuration/#understand-force_entry_enable)
