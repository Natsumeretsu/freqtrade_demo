...
- 来源：https://www.freqtrade.io/en/stable/recursive-analysis/
- 离线保存时间：Mon Jan 05 2026 11:43:10 GMT+0800 (中国标准时间)
...
head over to the [Data Downloading](https://www.freqtrade.io/en/stable/data-download/) section of the documentation.
...
In addition to the recursive formula check, this command also carries out a simple lookahead bias check on the indicator values only. For a full lookahead check, use [Lookahead-analysis](https://www.freqtrade.io/en/stable/lookahead-analysis/).
