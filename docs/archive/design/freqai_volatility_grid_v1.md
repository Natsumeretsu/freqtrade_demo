...
- 策略代码：`01_freqtrade/strategies_archive/FreqaiVolatilityGridV1.py`
- 推荐配置：`04_shared/configs/archive/freqai/volatility_grid_btc_1h_v1.json`
...
./scripts/ft.ps1 backtesting `
  --config "04_shared/configs/archive/freqai/volatility_grid_btc_1h_v1.json" `
