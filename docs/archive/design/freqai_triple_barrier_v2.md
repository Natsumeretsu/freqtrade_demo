...
- 策略代码：`01_freqtrade/strategies_archive/FreqaiTripleBarrierV2.py`
- 推荐配置：`04_shared/configs/archive/freqai/triple_barrier_1h_v2.json`
...
./scripts/ft.ps1 backtesting `
  --config "04_shared/configs/archive/freqai/triple_barrier_1h_v2.json" `
