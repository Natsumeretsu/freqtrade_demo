...
- 策略代码：`01_freqtrade/strategies_archive/FreqaiCTATrendV3.py`
- 推荐配置：`04_shared/configs/archive/freqai/cta_trend_btc_1h_v3.json`
...
./scripts/ft.ps1 backtesting `
  --config "04_shared/configs/archive/freqai/cta_trend_btc_1h_v3.json" `
