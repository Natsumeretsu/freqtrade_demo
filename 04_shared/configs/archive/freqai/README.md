...
./scripts/ft.ps1 backtesting --config "04_shared/configs/archive/freqai/lgbm_classifier_trend_v1.json" --strategy-path "01_freqtrade/strategies_archive" --strategy "FreqaiLGBMClassifierTrendStrategy" --freqaimodel "LightGBMClassifier" --timeframe "1h" --timeframe-detail "5m" --timerange "$start-$end" --pairs "BTC/USDT"
```
