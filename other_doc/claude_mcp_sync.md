...
本文面向团队/多电脑场景：在新电脑拉取本项目后，一键把常用 MCP（Serena / Context7 / MarkItDown / Playwright / Chrome DevTools / Wolfram / GitHub）配置到 **Claude Code（`claude` CLI）**。
...
```powershell
powershell.exe -ExecutionPolicy Bypass -File "./scripts/mcp/setup_claude.ps1"
```
