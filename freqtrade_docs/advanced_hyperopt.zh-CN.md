# 超参优化（高级）（Advanced Hyperopt）

这份文档由 Freqtrade 官方页面离线保存后整理为便于“vibe coding 查阅使用”的 Markdown。

- 来源：https://www.freqtrade.io/en/stable/advanced-hyperopt/
- 离线保存时间：Mon Jan 05 2026 11:44:11 GMT+0800 (中国标准时间)
...
Parameters can also be defined dynamically, but must be available to the instance once the [`bot_start()` callback](https://www.freqtrade.io/en/stable/strategy-callbacks/#bot-start) has been called.
