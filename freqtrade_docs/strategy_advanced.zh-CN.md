...
- 来源：https://www.freqtrade.io/en/stable/strategy-advanced/
- 离线保存时间：Mon Jan 05 2026 11:43:55 GMT+0800 (中国标准时间)
...
If you're just getting started, please familiarize yourself with the [Freqtrade basics](https://www.freqtrade.io/en/stable/bot-basics/) and methods described in [Strategy Customization](https://www.freqtrade.io/en/stable/strategy-customization/) first.

The call sequence of the methods described here is covered under [bot execution logic](https://www.freqtrade.io/en/stable/bot-basics/#bot-execution-logic). Those docs are also helpful in deciding which method is most suitable for your customisation needs.
...
文件：`user_data/strategies/myawesomestrategy.py`
...
文件：`user_data/strategies/MyAwesomeStrategy2.py`
