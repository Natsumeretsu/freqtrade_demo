...
- 来源：https://www.freqtrade.io/en/stable/faq/
- 离线保存时间：Mon Jan 05 2026 11:45:10 GMT+0800 (中国标准时间)
...
Freqtrade supports spot trading, as well as (isolated) futures trading for some selected exchanges. Please refer to the [documentation start page](https://www.freqtrade.io/en/stable/#supported-futures-exchanges-experimental) for an up-to-date list of supported exchanges.
...
Please make sure to read the [relevant documentation page](https://www.freqtrade.io/en/stable/leverage/) first.
...
Futures trading is supported for selected exchanges. Please refer to the [documentation start page](https://www.freqtrade.io/en/stable/#supported-futures-exchanges-experimental) for an up-to-date list of supported exchanges.
...
You can however use the [`adjust_trade_position()` callback](https://www.freqtrade.io/en/stable/strategy-callbacks/#adjust-trade-position) to adjust an open position.
...
- Please check the [Installation documentation](https://www.freqtrade.io/en/stable/installation/).
...
You can use "current" market data by using the [dataprovider](https://www.freqtrade.io/en/stable/strategy-customization/#orderbookpair-maximum)'s orderbook or ticker methods - which however cannot be used during backtesting.
...
Please look at the [advanced setup documentation Page](https://www.freqtrade.io/en/stable/advanced-setup/#running-multiple-instances-of-freqtrade).
...
If you're on an older version, please follow the [upgrade instructions](https://www.freqtrade.io/en/stable/updating/) and see if your problem has already been addressed.
