...
- 来源：https://www.freqtrade.io/en/stable/docker_quickstart/
- 离线保存时间：Mon Jan 05 2026 11:34:43 GMT+0800 (中国标准时间)
...
You will find more information about Strategy development in the [Strategy documentation](https://www.freqtrade.io/en/stable/strategy-customization/).
...
Please also read the [API configuration with docker](https://www.freqtrade.io/en/stable/rest-api/#configuration-with-docker) section to learn more about this configuration.
...
If you intend to use freqUI, please also ensure to adjust the [configuration accordingly](https://www.freqtrade.io/en/stable/rest-api/#configuration-with-docker), otherwise the UI will not be available.
...
Head over to the [Data Downloading Documentation](https://www.freqtrade.io/en/stable/data-download/) for more details on downloading data.
...
Head over to the [Backtesting Documentation](https://www.freqtrade.io/en/stable/backtesting/) to learn more.
...
Commands `freqtrade plot-profit` and `freqtrade plot-dataframe` ([Documentation](https://www.freqtrade.io/en/stable/plotting/)) are available by changing the image to `*_plot` in your `docker-compose.yml` file.
