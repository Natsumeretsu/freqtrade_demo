# 工具子命令（Utility Subcommands）

这份文档由 Freqtrade 官方页面离线保存后整理为便于“vibe coding 查阅使用”的 Markdown。

- 来源：https://www.freqtrade.io/en/stable/utils/
- 离线保存时间：Mon Jan 05 2026 11:41:34 GMT+0800 (中国标准时间)
...
Only vital questions are asked. Freqtrade offers a lot more configuration possibilities, which are listed in the [Configuration documentation](https://www.freqtrade.io/en/stable/configuration/#configuration-parameters)
...
Especially useful with [split configuration files](https://www.freqtrade.io/en/stable/configuration/#multiple-configuration-files) or [environment variables](https://www.freqtrade.io/en/stable/configuration/#environment-variables), where this command will show the merged configuration.
...
Results will be located in `user_data/strategies/.py`.
...
Use the `test-pairlist` subcommand to test the configuration of [dynamic pairlists](https://www.freqtrade.io/en/stable/plugins/#pairlists).
...
Show whitelist when using a [dynamic pairlist](https://www.freqtrade.io/en/stable/plugins/#pairlists).
...
Please refer to the [corresponding documentation](https://www.freqtrade.io/en/stable/advanced-setup/#use-a-different-database-system) to learn about requirements for different database systems.
...
More details in the [Backtesting analysis](https://www.freqtrade.io/en/stable/advanced-backtesting/#analyze-the-buyentry-and-sellexit-tags) Section.
