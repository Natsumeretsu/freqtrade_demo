...
建议按顺序阅读；每章结尾都附“延伸阅读（参考库）”。

1. [阅读指南](chapters/00_reading_guide.zh-CN.md)
2. [环境准备](chapters/01_environment_setup.zh-CN.md)
3. [配置入门](chapters/02_configuration.zh-CN.md)
4. [数据与回测](chapters/03_data_backtest.zh-CN.md)
5. [策略开发](chapters/04_strategy_development.zh-CN.md)
6. [超参优化](chapters/05_hyperopt.zh-CN.md)
